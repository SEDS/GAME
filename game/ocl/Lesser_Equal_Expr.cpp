...
bool Lesser_Equal_Expr::evaluate (Ocl_Context & res)
{
  ...
  else if (res.model_attributes)
  {
    ...
    if (left != 0 || right != 0 )
    {
      ...
      {
        // TODO Added callback to context to add new attribute command
        //      actions.
      }
      ...
      switch (flag) {
        case 1:
          {
            if (left_value > right_value)
            {
              ...
              // TODO Add callback to context to delete objects.
              ret = true;
            }
            break;
          }
        case 2:
          if (right_value < left_value)
          {
            ...
            // TODO Add callback to context to add objects.
            ret = true;
          }
          break;
        ...
        case 3:
          {
            ...
            // TODO Verify the return values are correct.
            break;
          }
